    ...
    public function handle(Request $request, Closure $next, $guards=null)
    {
        ...
        try {
            ...
            if ($e instanceof NoTokenException) {
                return response()->json(['error' => 'UNAUTHORIZED_REQUEST', 'message' => 'Token required for this request'], 401);
            } //End if

            if ($e instanceof InvalidTokenException) {
                return response()->json(['error' => 'UNAUTHORIZED_REQUEST', 'exception' => 'Token is invalid'], 401);
            } //End if
