...
return [
    ...
    */
    ...
    |
    */
    'app_client_id'     => array_key_exists('AWS_COGNITO_CLIENT_ID', $_SERVER) ? $_SERVER['AWS_COGNITO_CLIENT_ID'] : env('AWS_COGNITO_CLIENT_ID'),
    'app_client_secret' => array_key_exists('AWS_COGNITO_CLIENT_SECRET', $_SERVER) ? $_SERVER['AWS_COGNITO_CLIENT_SECRET'] : env('AWS_COGNITO_CLIENT_SECRET'),
    'user_pool_id'      => array_key_exists('AWS_COGNITO_USER_POOL_ID', $_SERVER) ? $_SERVER['AWS_COGNITO_USER_POOL_ID'] : env('AWS_COGNITO_USER_POOL_ID'),
    'region'            => array_key_exists('AWS_COGNITO_REGION', $_SERVER) ? $_SERVER['AWS_COGNITO_REGION'] : env('AWS_COGNITO_REGION','us-east-1'),
    'version'           =>  array_key_exists('AWS_COGNITO_VERSION', $_SERVER) ? $_SERVER['AWS_COGNITO_VERSION'] : env('AWS_COGNITO_VERSION','latest'),
    ...
    |
    */
    'app_client_secret_allow' =>  array_key_exists('AWS_COGNITO_CLIENT_SECRET_ALLOW', $_SERVER) ? $_SERVER['AWS_COGNITO_CLIENT_SECRET_ALLOW'] : env('AWS_COGNITO_CLIENT_SECRET_ALLOW',true),
    ...
    */
    ...
    |
    */
    'add_user_delivery_mediums'     =>    array_key_exists('AWS_COGNITO_ADD_USER_DELIVERY_MEDIUMS', $_SERVER) ? $_SERVER['AWS_COGNITO_ADD_USER_DELIVERY_MEDIUMS'] : env('AWS_COGNITO_ADD_USER_DELIVERY_MEDIUMS','DEFAULT')  ,
    ...
    |
    */
    'add_missing_local_user_sso'    => array_key_exists('AWS_COGNITO_ADD_LOCAL_USER', $_SERVER) ? $_SERVER['AWS_COGNITO_ADD_LOCAL_USER'] : env('AWS_COGNITO_ADD_LOCAL_USER',false),
    'delete_user'  =>  array_key_exists('AWS_COGNITO_DELETE_USER', $_SERVER) ? $_SERVER['AWS_COGNITO_DELETE_USER'] : env('AWS_COGNITO_DELETE_USER',false),

    // Package configurations
    'sso_user_model'        =>  array_key_exists('AWS_COGNITO_USER_MODEL', $_SERVER) ? $_SERVER['AWS_COGNITO_USER_MODEL'] : env('AWS_COGNITO_USER_MODEL', User::class),
    ...
    |
    */
    'storage_provider' => array_key_exists('AWS_COGNITO_TOKEN_STORAGE', $_SERVER) ? $_SERVER['AWS_COGNITO_TOKEN_STORAGE'] : env('AWS_COGNITO_TOKEN_STORAGE','file'),
    ...
    */
    ...
    |
    */
    'force_password_change_web' =>   array_key_exists('AWS_COGNITO_FORCE_PASSWORD_CHANGE_WEB', $_SERVER) ? $_SERVER['AWS_COGNITO_FORCE_PASSWORD_CHANGE_WEB'] : env('AWS_COGNITO_FORCE_PASSWORD_CHANGE_WEB',false),
    'force_redirect_route_name' =>    array_key_exists('AWS_COGNITO_FORCE_PASSWORD_ROUTE_NAME', $_SERVER) ? $_SERVER['AWS_COGNITO_FORCE_PASSWORD_ROUTE_NAME'] : env('AWS_COGNITO_FORCE_PASSWORD_ROUTE_NAME','cognito.form.change.password'),
    ...
    |
    */
    'force_password_change_api' =>   array_key_exists('AWS_COGNITO_FORCE_PASSWORD_CHANGE_API', $_SERVER) ? $_SERVER['AWS_COGNITO_FORCE_PASSWORD_CHANGE_API'] : env('AWS_COGNITO_FORCE_PASSWORD_CHANGE_API',false),
    ...
    |
    */
    'force_password_auto_update_api' =>  array_key_exists('AWS_COGNITO_FORCE_PASSWORD_AUTO_UPDATE_API', $_SERVER) ? $_SERVER['AWS_COGNITO_FORCE_PASSWORD_AUTO_UPDATE_API'] : env('AWS_COGNITO_FORCE_PASSWORD_AUTO_UPDATE_API',false),
    ...
    |
    */
    'allow_forgot_password_resend' =>  array_key_exists('AWS_COGNITO_ALLOW_FORGOT_PASSWORD_RESEND', $_SERVER) ? $_SERVER['AWS_COGNITO_ALLOW_FORGOT_PASSWORD_RESEND'] : env('AWS_COGNITO_ALLOW_FORGOT_PASSWORD_RESEND',true),
    ...
    |
    */
    'force_new_user_email_verified' =>  array_key_exists('AWS_COGNITO_FORCE_NEW_USER_EMAIL_VERIFIED', $_SERVER) ? $_SERVER['AWS_COGNITO_FORCE_NEW_USER_EMAIL_VERIFIED'] : env('AWS_COGNITO_FORCE_NEW_USER_EMAIL_VERIFIED',true),
    ...
    |
    */
    'new_user_message_action' =>  array_key_exists('AWS_COGNITO_NEW_USER_MESSAGE_ACTION', $_SERVER) ? $_SERVER['AWS_COGNITO_NEW_USER_MESSAGE_ACTION'] : env('AWS_COGNITO_NEW_USER_MESSAGE_ACTION',null)
